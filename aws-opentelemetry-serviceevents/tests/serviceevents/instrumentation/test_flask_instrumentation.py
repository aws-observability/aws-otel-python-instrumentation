...
import amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation as flask_mod
...
class TestFlaskHookFunctions(TestCase):
    ...
    @patch("amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.set_current_operation")
    @patch("amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.time")
    def test_before_request_sets_operation_context(self, mock_time, mock_set_operation):
        ...
        with patch(
            "amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.g", mock_g, create=True
        ):
            with patch(
                "amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.request",
                mock_request,
                create=True,
            ):
    ...
    @patch("amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.clear_current_operation")
    ...
    @patch("amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation._ServiceEventsMonitorState")
    @patch("amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.clear_current_operation")
    ...
    def test_teardown_infers_500_from_exception(self, mock_clear):
        ...
        with patch("amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.time") as mock_time:
...
class TestFlaskHookCrashSafety(TestCase):
    ...
    @patch(
        "amazon.opentelemetry.serviceevents.instrumentation.flask_instrumentation.set_current_operation",
