...
import amazon.opentelemetry.serviceevents.instrumentation.fastapi_instrumentation as fastapi_mod
...
class TestFastAPIMiddleware(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("amazon.opentelemetry.serviceevents.instrumentation.fastapi_instrumentation.clear_current_operation")
    @patch("amazon.opentelemetry.serviceevents.instrumentation.fastapi_instrumentation.set_current_operation")
...
class TestFastAPIMiddlewareCrashSafety(unittest.IsolatedAsyncioTestCase):
    ...
    @patch(
        "amazon.opentelemetry.serviceevents.instrumentation.fastapi_instrumentation.set_current_operation",
