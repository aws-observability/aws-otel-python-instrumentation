...
import amazon.opentelemetry.serviceevents.instrumentation.django_instrumentation as django_mod
...
class TestInstallDjangoHooks(TestCase):
    ...
    def test_instrumented_load_middleware_injects_for_build_then_restores(self):
        ...
        middleware_path = (
            "amazon.opentelemetry.serviceevents.instrumentation."
...
class TestServiceEventsDjangoMiddleware(TestCase):
    ...
    def test_call_records_start_time(self):
        ...
        with patch(
            "amazon.opentelemetry.serviceevents.instrumentation.django_instrumentation.time"
        ) as mock_time:
    ...
    @patch("amazon.opentelemetry.serviceevents.instrumentation.django_instrumentation.set_current_operation")
    ...
    @patch(
        "amazon.opentelemetry.serviceevents.instrumentation.django_instrumentation.set_current_operation",
...
class TestFinalizeRequest(TestCase):
    ...
    @patch("amazon.opentelemetry.serviceevents.instrumentation.django_instrumentation.clear_current_operation")
