...
from amazon.opentelemetry.serviceevents.models.deployment_telemetry import DeploymentContext, DeploymentEventTelemetry
...
from amazon.opentelemetry.serviceevents.models.incident_telemetry import (
    CallPathEntry,
    ExceptionInfo,
    IncidentSnapshot,
    RequestContext,
...
class TestDeploymentEventSimplified(TestCase):
    ...
    def test_no_functions_field(self):
        ...
        from amazon.opentelemetry.serviceevents.models import deployment_telemetry
