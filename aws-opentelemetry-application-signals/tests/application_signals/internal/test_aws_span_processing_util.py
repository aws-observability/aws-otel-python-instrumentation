...
from amazon.opentelemetry.application_signals.internal.semconv.aws_attributes import AWS_CONSUMER_PARENT_SPAN_KIND, AWS_LOCAL_OPERATION
...
class TestOperationPaths(TestCase):
    ...
    def setUp(self):
        from amazon.opentelemetry.application_signals.internal.aws_span_processing_util import reset_operation_paths
    ...
    def test_segments_match_exact(self):
        from amazon.opentelemetry.application_signals.internal.aws_span_processing_util import _segments_match
    ...
    def test_apply_empty_config_returns_original(self):
        from amazon.opentelemetry.application_signals.internal.aws_span_processing_util import apply_operation_path_span_name
