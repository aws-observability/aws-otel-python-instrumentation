...
from amazon.opentelemetry.application_signals.internal.semconv.aws_attributes import AWS_CONSUMER_PARENT_SPAN_KIND, AWS_SDK_DESCENDANT
from amazon.opentelemetry.application_signals.internal.aws_span_processing_util import get_ingress_operation
from amazon.opentelemetry.application_signals.processor.attribute_propagating_span_processor import AttributePropagatingSpanProcessor
