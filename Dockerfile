...
# aws-opentelemetry-components is an unpublished sibling package; install it from local source
# and drop the pinned dependency so the distro install doesn't try to fetch it from PyPI.
