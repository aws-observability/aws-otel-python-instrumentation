...
class ServerWrapper(McpWrapper):
    ...
    async def _wrap_server_message_handler(
        ...
        carrier = self._extract_trace_context(incoming_msg, args)
    ...
    def _extract_trace_context(
        self, message: Any, args: Tuple[Any, ...]
