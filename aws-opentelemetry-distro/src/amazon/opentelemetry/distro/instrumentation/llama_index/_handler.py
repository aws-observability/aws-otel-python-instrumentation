...
from amazon.opentelemetry.distro.gen_ai._context import attach_llm_span_context
...
class _SpanHandler(BaseSpanHandler[_Span], extra="allow"):
    ...
    def new_span(
        ...
        **kwargs: Any,
        ...
        token = attach_llm_span_context(
            otel_span,
            parent.context if parent else None,
            collapse_http_span=kind == SpanKind.CLIENT,
        )
