...
AWS_TABLE_NAME: str = SpanAttributes.AWS_DYNAMODB_TABLE_NAMES # "aws.table.name" -> "aws.dynamodb.table_names"
AWS_BUCKET_NAME: str = SpanAttributes.AWS_S3_BUCKET # "aws.bucket.name" -> "aws.s3.bucket"
