...
from amazon.opentelemetry.distro._aws_attribute_keys import AWS_XRAY_ADAPTIVE_SAMPLING_CONFIGURED_ATTRIBUTE_KEY
...
class _AwsSamplingResult(SamplingResult):
    ...
    def __init__(
        ...
        self.attributes = MappingProxyType(
            {
                **self.attributes,
                AWS_XRAY_ADAPTIVE_SAMPLING_CONFIGURED_ATTRIBUTE_KEY: has_adaptive_sampling_config,
            }
        )
