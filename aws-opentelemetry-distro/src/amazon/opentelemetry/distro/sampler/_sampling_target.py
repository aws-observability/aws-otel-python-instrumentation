...
class _SamplingBoost:
    def __init__(self, BoostRate: float = None, BoostRateTTL: float = None):
...
class _SamplingTarget:
    def __init__(
        ...
        SamplingBoost: _SamplingBoost = None,
        RuleName: str = None,
    ):
        ...
        self.SamplingBoost = SamplingBoost  # can be None
...
class _SamplingTargetResponse:
    def __init__(
        ...
        UnprocessedBoostStatistics: List[_UnprocessedStatistics] | None = None,
    ):
