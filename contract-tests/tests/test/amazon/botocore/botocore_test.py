...
_AWS_BEDROCK_KNOWLEDGEBASE_ID: str = "aws.bedrock.knowledgebase_id"
_AWS_BEDROCK_DATASOURCE_ID: str = "aws.bedrock.datasource_id"
_AWS_BEDROCK_RUNTIME_MODEL_ID: str = "gen_ai.request.model"
...
class BotocoreTest(ContractTestBase):
    ...
    def test_bedrock_invoke_model(self):
        self.do_test_requests(
            ...
            request_specific_attributes={
                _AWS_BEDROCK_RUNTIME_MODEL_ID: "amazon.titan-text-premier-v1:0",
            },
