...
class ContractTestBase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        time.sleep(0.1) # Sleep for 100ms to ensure any startup metrics have been exported
        self.mock_collector_client.clear_signals() # Clear all start up metrics, so tests are only testing telemetry generated by their invocations.
