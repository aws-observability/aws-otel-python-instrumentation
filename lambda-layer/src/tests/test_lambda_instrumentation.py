...
MOCK_XRAY_TRACE_CONTEXT_COMMON = (f"Root={TRACE_ID_VERSION}-{MOCK_XRAY_TRACE_ID_STR[:TRACE_ID_FIRST_PART_LENGTH]}"
        ...
        mock_execute_lambda(
            {
                "headers": {
                    ...
                    TraceContextTextMapPropagator._TRACESTATE_HEADER_NAME:
                        f"{MOCK_W3C_TRACE_STATE_KEY}={MOCK_W3C_TRACE_STATE_VALUE},foo=1,bar=2",
                }
            }
        )
