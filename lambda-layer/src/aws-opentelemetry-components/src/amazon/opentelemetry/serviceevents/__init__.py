...
def __getattr__(name):
    ...
    if name == "ServiceEventsConfig":
        from amazon.opentelemetry.serviceevents.config import (  # pylint: disable=import-outside-toplevel
            ServiceEventsConfig,
        )
    ...
    if name == "ServiceEventsInstrumentor":
        # pylint: disable-next=import-outside-toplevel
        from amazon.opentelemetry.serviceevents.serviceevents_instrumentation import ServiceEventsInstrumentor

        return ServiceEventsInstrumentor
