...
public class AppPerfResults {
  ...
  final double requestLatencyP91;
  final double requestLatencyP92;
  final double requestLatencyP93;
  final double requestLatencyP94;
  final double requestLatencyP95;
  final double requestLatencyP96;
  final double requestLatencyP97;
  final double requestLatencyP98;
  final double requestLatencyP99;
  final double requestLatencyP999;
  ...
  private AppPerfResults(Builder builder) {
    ...
    this.requestLatencyP91 = builder.requestLatencyP91;
    this.requestLatencyP92 = builder.requestLatencyP92;
    this.requestLatencyP93 = builder.requestLatencyP93;
    this.requestLatencyP94 = builder.requestLatencyP94;
    this.requestLatencyP95 = builder.requestLatencyP95;
    this.requestLatencyP96 = builder.requestLatencyP96;
    this.requestLatencyP97 = builder.requestLatencyP97;
    this.requestLatencyP98 = builder.requestLatencyP98;
    this.requestLatencyP99 = builder.requestLatencyP99;
    this.requestLatencyP999 = builder.requestLatencyP999;
  ...
  static class Builder {
    ...
    public double requestLatencyP91;
    public double requestLatencyP92;
    public double requestLatencyP93;
    public double requestLatencyP94;
    public double requestLatencyP95;
    public double requestLatencyP96;
    public double requestLatencyP97;
    public double requestLatencyP98;
    public double requestLatencyP99;
    public double requestLatencyP999;
